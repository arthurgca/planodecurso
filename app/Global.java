...
public class Global extends GlobalSettings {
    ...
    private void configureDisciplinas() {
        ...
        CatalogoDeDisciplinas.register("CALCULO2", "Cálculo Diferencial e Integral II", 4,
                                       "CALCULO1");
        CatalogoDeDisciplinas.register("DISCRETA", "Matemática Discreta", 4);
        CatalogoDeDisciplinas.register("MC", "Metodologia Científica", 4);
        CatalogoDeDisciplinas.register("P2", "Programação II", 4,
                                       "P1", "LP1", "IC");
        CatalogoDeDisciplinas.register("TG", "Teoria dos Grafos", 2,
                                       "P1", "LP1");
        CatalogoDeDisciplinas.register("FC", "Fundamentos de Física Clássica", 4,
                                       "CALCULO1", "VETORIAL");
        CatalogoDeDisciplinas.register("LP2", "Laboratório de Programação II", 4,
                                       "P1", "LP1", "IC");

        CatalogoDeDisciplinas.register("LINEAR", "Álgebra Linear", 4,
                                       "VETORIAL");
        CatalogoDeDisciplinas.register("PROBABILIDADE", "Probabilidade e Estatística", 4,
                                       "CALCULO2");
        CatalogoDeDisciplinas.register("TC", "Teoria da Computação", 4,
                                       "TG", "IC", "DISCRETA");
        CatalogoDeDisciplinas.register("EDA", "Estruturas de Dados e Algoritmos", 4,
                                       "P2", "LP2", "TG");
        CatalogoDeDisciplinas.register("FM", "Fundamentos de Física Moderna", 4,
                                       "CALCULO2", "FC");
        CatalogoDeDisciplinas.register("GI", "Gerência da Informação", 4);
        CatalogoDeDisciplinas.register("LEDA", "Lab de Estruturas de Dados e Algoritmos", 4,
                                       "P2", "LP2", "TG");
    }
